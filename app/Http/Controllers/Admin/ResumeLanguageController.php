...
use App\Http\Requests\Admin\ResumeLanguageRequest as StoreRequest;

use App\Http\Requests\Admin\ResumeLanguageRequest as UpdateRequest;
...
class ResumeLanguageController extends PanelController

{
...

	{
		...
		*/
		...
		$this->xPanel->setModel('App\Models\Resume_language');
		
		$this->xPanel->setRoute(admin_uri('resume/languages'));

		$this->xPanel->setEntityNameStrings('Language', 'Language');
