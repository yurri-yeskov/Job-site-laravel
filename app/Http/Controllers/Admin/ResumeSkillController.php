...
use App\Http\Requests\Admin\ResumeSkillListRequest as StoreRequest;

use App\Http\Requests\Admin\ResumeSkillListRequest as UpdateRequest;
...
class ResumeSkillController extends PanelController

{
...

	{
		...
		*/
		...
		$this->xPanel->setModel('App\Models\Skill_list');
		
		$this->xPanel->setRoute(admin_uri('resume/skills'));

		$this->xPanel->setEntityNameStrings('Skill', 'Skill');
