...
class Chatter_Models
{
    ...
    {
        static::$models[Chatter_Category::class] = $model;
    }
    ...
    {
        static::$models[Chatter_Discussion::class] = $model;
    }
    ...
    {
        static::$models[Chatter_Post::class] = $model;
    }
    ...
    {
        return self::makeModel(Chatter_Category::class, $attributes);
    }
    ...
    {
        return self::makeModel(Chatter_Discussion::class, $attributes);
    }
    ...
    {
        return self::makeModel(Chatter_Post::class, $attributes);
    }
