        ...
        <div class="row">
            <div class="col-lg-12 col-md-12" style="margin-top: 26px;">
                <div class="post-list-row">
                    <!-- <div class="row worker-list-top-bar"> -->
                    <div class="col-lg-12  worker-list-top-bar">
                        <div class="row">
                            <div class="col-lg-4 ">
                                <h5>Resume Alerts</h5>
                            </div>
                            <div class="col-lg-8 text-right">
                                <button class="post-list-post-button">Setup Job Alerts</button>
                            </div>
                        </div>
                    </div>
                </div>
