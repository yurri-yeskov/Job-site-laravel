                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="rate" id="rate" class="form-control">
                                                ...
                                                <option value="{{ $salaryType->id }}" >{{ t('per') . ' ' . $salaryType->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var indsArr = '<?php echo $inds_arr; ?>';
        console.log('indsArr ------------\n', JSON.parse(indsArr))
        var selectbox = '';
        // for(var i = 0; i < indsArr.length; i++){
        //     selectbox = selectbox+'<option value="'+indsArr[i]['name']+'">'+indsArr[i]['name']+' </option>';
        // }
