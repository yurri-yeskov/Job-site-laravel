...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{$activeMenu == 'CompanyController.index' ? 'active' : ''}}">
            ...
            <li class="nav-item  {{$activeMenu == 'profileController.getCompanyProfile' ? 'active' : ''}}">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link {{$activeMenu == 'PostsController.list' ? '' : 'collapsed'}}"  href="#" data-toggle="collapse" data-target="#collapseJob" aria-expanded="true" aria-controls="collapseJob">
                    <i class="fas fa-fw"><img src="{{asset('icons/job.png')}}" alt=""></i>
                    <span>Jobs Management</span>
                </a>
                <div id="collapseJob" class="collapse {{$activeMenu == 'PostsController.list' ? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/company/post/manage?c=true">Post a New Job</a>
                        <a class="collapse-item {{$activeMenu == 'PostsController.list' ? 'text-white' : ''}}" href="/company/post/manage">Manage Jobs</a>
                    </div>
                </div>
            </li>
