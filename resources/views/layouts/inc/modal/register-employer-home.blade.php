<div class="modal fade" id="quickEmployerHomeSignup" tabindex="-1" role="dialog">
					...
					<div class="signup-one">
						...
						<form role="form" method="POST" >
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="empSingupEmail" name="empSingupEmail" type="email" class="form-control" placeholder="{{ t('email') }}" autocomplete="off" >
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="empSingupPassword" name="empSingupPassword" type="password" class="form-control" placeholder="{{ t('password') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
							...
							<div class="form-group row mt-5">
								<div class="col-md-12">
									<button id="employerSignupBtn" class="btn btn-custom btn-lg "> {{ t('Next') }} </button>
								</div>
							</div>
							...
							<div class="social-icon-main">
								<ul>
									<li class="btn-lkin"><a href="{{ url('auth/linkedin') }}?type=signup" class="btn-lkin" onclick="return employerSignup(this)"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<li class="btn-tw">
										<a href="{{ url('auth/twitter') }}?type=signup" class="btn-tw" onclick="return employerSignup(this)">
									...
									<li class="btn-fb">
										<a href="{{ url('auth/facebook') }}?type=signup" class="btn-fb" onclick="return employerSignup(this)"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<li ><a href="{{ url('auth/google') }}?type=signup" onclick="return employerSignup(this)">
										<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<defs>
											<linearGradient id="paint4_linear" x1="24.9166" y1="14.0802" x2="24.9166" y2="35.6807" gradientUnits="userSpaceOnUse">
									...
									<li class="btn-yw"><a href="{{ url('auth/yahoo') }}?type=signup" onclick="return employerSignup(this)" class="btn-yw">
					...
					<div class="signup-two" style="display:none">
						...
						<form role="form" method="POST">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="emp_first_name" name="emp_first_name" type="text" class="form-control" placeholder="{{ t('first_name') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
							...
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="emp_last_name" name="emp_last_name" type="text" class="form-control" placeholder="{{ t('last_name') }}" autocomplete="off" >
										<span class="icon-append show-pwd">
							...
							<!-- country -->
							<input type="hidden" name="country_id" class="employerCountryId"/>
							<div class="form-group row required">
								<div class="col-md-12">
									<div class="input-group show-pwd-group">
										<input id="emp_country" name="emp_country" type="text" class="form-control countrySearch" placeholder="Country" autocomplete="off" >
										<span class="icon-append show-pwd">
							...
							<div class="form-group row mt-5 mb-5">
								<div class="col-md-12">
									<button id="employersignupBtnWSecond" class="btn btn-custom btn-lg "> {{ t('submit') }} </button>
								</div>
							</div>
						</form>
					</div>
			...
			<div class="signup-three" style="display:none">
				...
				<div class="signup-code-wrap">
				    ...
				    <div class="alert-remail" >
						...
						<span class="resend-mail sendMailEmployer">{{t('resend_verification_code')}}</span>
				    </div>
				</div>
				<div class="ver-code-wrap">
					<form role="form" method="POST">
						<div class="form-group row required">
							<div class="col-md-12">
								<div class="input-group show-pwd-group">
									<input id="quickemployer_code" name="quickemployer_code" type="text" class="form-control" placeholder="{{t('enter_verification_code')}}" autocomplete="off" >
									<span class="icon-append show-pwd">
						...
						<div class="form-group row mt-5 mb-5">
							<div class="col-md-12">
								<button id="employersignupBtnWThird" class="btn btn-custom btn-lg "> {{ t('submit') }} </button>
							</div>
						</div>
					</form>
				</div>
