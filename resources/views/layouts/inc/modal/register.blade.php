						...
						<form role="form" method="POST">
							...
							<div class="worker-area">
								...
								<div class="form-group row required">
									<div class="col-md-12">
										<div class="input-group show-pwd-group">
											<input id="city_a" name="city" type="text" class="form-control citySearch" placeholder="City" autocomplete="off" >
											<span class="icon-append show-pwd">
							...
							<div class="employer-area" style="display: none;">
								<input type="hidden" name="country_id" class="employerCountryId" />
								<div class="form-group row required">
									<div class="col-md-12">
										<div class="input-group show-pwd-group">
											<input id="emp_country_a" name="country" type="text" class="form-control countrySearch" placeholder="Country" autocomplete="off" >
											<span class="icon-append show-pwd">
