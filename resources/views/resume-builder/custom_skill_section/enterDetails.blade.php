									...
									<input type="hidden" name="basic_form_id" value="@if(!empty($data['basic_information'][0]->id)){{$data['basic_information'][0]->id}}@endif">
										<div class="row">
										 <div class="col-lg-12 col-sm-12">	
											  ...
											  <div class="form-group required">
												...
												<input type="text" class="form-control" placeholder="" name="resume_name" value="@if(!empty($data['basic_information'][0]->resume_name)){{$data['basic_information'][0]->resume_name}}@endif">
											  </div>
										  </div>
										 <div class="col-lg-6 col-sm-6">
											  ...
											  <div class="form-group required">
												...
												<input type="text" class="form-control" placeholder="" name="first_name" value="@if(!empty($data['basic_information'][0]->first_name)){{$data['basic_information'][0]->first_name}}@endif">
											  </div>
										  </div>
										  <div class="col-lg-6 col-sm-6">
											<?php $LastNameError = (isset($errors) and $errors->has('last_name')) ? ' is-invalid' : ''; ?>										  
											   <div class="form-group required">
												...
												<input type="text" class="form-control{{ $LastNameError }}" placeholder="" name="last_name" value="@if(!empty($data['basic_information'][0]->last_name)){{$data['basic_information'][0]->last_name}}@endif">
											   </div>
										  </div>
										 <div class="col-lg-6 col-sm-6">
											<?php $jobError = (isset($errors) and $errors->has('job_title')) ? ' is-invalid' : ''; ?>
											  <div class="form-group required">
												...
												<input type="text" class="form-control{{ $jobError }}" placeholder="" name="job_title" value="@if(!empty($data['basic_information'][0]->job_title)){{$data['basic_information'][0]->job_title}}@endif">
											  </div>
										  </div>
										  <div class="col-lg-6 col-sm-6">
											<?php $emailError = (isset($errors) and $errors->has('email')) ? ' is-invalid' : ''; ?>										  
											   <div class="form-group required">
												...
												<input type="email" class="form-control{{ $emailError }}" placeholder="" name="email" value="@if(!empty($data['basic_information'][0]->email)){{$data['basic_information'][0]->email}}@endif">
											   </div>
										  </div>
										 <div class="col-lg-6 col-sm-6">
											<?php $phoneError = (isset($errors) and $errors->has('phone')) ? ' is-invalid' : ''; ?>
											  <div class="form-group required">
												...
												<input type="number" class="form-control{{ $phoneError }}" placeholder="" name="phone" value="@if(!empty($data['basic_information'][0]->phone)){{$data['basic_information'][0]->phone}}@endif" maxlength="10">
											  </div>
										  </div>
										  <div class="col-lg-6 col-sm-6">
												 <div class="row">
													...
													@endif
													   <div class="form-group required">
														...
														<select class="form-control" id="exampleFormControlSelect1" name="current_salary">
												...
												@endif
													   <div class="form-group required">
															...
															<select class="form-control" id="exampleFormControlSelect1" name="expected_salary">
										   ...
										   <div class="col-lg-6 col-sm-6">	
										    <?php $experienceError = (isset($errors) and $errors->has('experience')) ? ' is-invalid' : ''; ?>
											  <div class="form-group required">
												...
												<input type="text" class="form-control{{ $experienceError }}" placeholder="" name="experience" value="@if(!empty($data['basic_information'][0]->experience)){{$data['basic_information'][0]->experience}}@endif">
											  </div>
										  </div>
										  <div class="col-lg-6 col-sm-6">
										...
										<div class="col-lg-12 col-sm-12">	
											   <div class="form-group required">
												...
												<select class="form-control select_language_multiple" id="exampleFormControlSelect_language" name="languages[]" multiple="multiple">
													@php
														$explanguage = array();
										  ...
										  <div class="col-lg-12 col-sm-12">	
											  ...
											  <div class="form-group required">
												...
												<select class="form-control select_industry_multiple" id="exampleFormControlSelect1" name="work_industries[]" multiple="multiple">
													@php
														$expwork = array();
										  ...
										  <div class="col-lg-12 col-sm-12">
											<?php $descriptionError = (isset($errors) and $errors->has('description')) ? ' is-invalid' : ''; ?>										  
											  <div class="form-group required">
												...
												<textarea class="form-control{{ $descriptionError }}" rows="4" name="description">@if(!empty($data['basic_information'][0]->description)){{$data['basic_information'][0]->description}}@endif</textarea>
											  </div>
										  </div>
				...
				<div class="row row-pad">
					<div class="col-sm-6">
						<div class="experience">
							...
							<div class="custom_section">@if($data['custom_section_html'] !=''){!!$data['custom_section_html']!!}@endif</div>
							<div class="courses_section">@if($data['course_html'] !=''){!!$data['course_html']!!}@endif</div>	
		
							<div class="extra_curricular_section">@if($data['curricular_activities_section_html'] !=''){!!$data['curricular_activities_section_html']!!}@endif</div>
							<div class="internships_section">@if($data['internships_section_html'] !=''){!!$data['internships_section_html']!!}@endif</div>
							<div class="hobbies_section">@if($data['hobby_section_html'] !=''){!!$data['hobby_section_html']!!}@endif</div>
							<!--<div class="references_section">@if($data['references_section_html'] !=''){!!$data['references_section_html']!!}@endif</div>-->
							
							
							
							<div class="languages_section">@if($data['languages_section_html'] !=''){!!$data['languages_section_html']!!}@endif</div>
							<div class="courses">
								<div class="row">
									<div class="col-lg-6 col-sm-6">
										<ul>
											...
											<!--<li><a href="javascript:void(0)" class="select_custom_skill @if($data['references_section_html'] !='') pointevent @endif" attr="references_section" attr_template_id="{{$data['template'][0]->id}}">References</a></li>-->
										</ul>
									</div>
									<div class="col-lg-6 col-sm-6">
										<ul>
...
-->							
					 ...
					 <div class="col-lg-12">
						<div class="last_sec">
							<a href="{{ route('resume.edit',$data['template'][0]->slug) }}">next</a>
						</div>
					</div>
				</div>
			</div>
