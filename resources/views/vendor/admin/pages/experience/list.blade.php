	...
	<div class="col-12">
		...
		<div class="card rounded">
			...
			<div class="card-header with-border pt-5">
				<a href="/admin/experience/create" class="btn btn-primary shadow ladda-button" data-style="zoom-in">
					<span class="ladda-label">
						<i class="fas fa-plus"></i> Add Experience Type
					</span>
				</a>
			</div>
			<div class="card-body">
				...
				<table id="crudTable" class="crudTable table table-bordered table-striped display dt-responsive nowrap" width="100%">
					...
					<tbody>
						@foreach($Experiencelist as $items)
						<tr>
							<?php
							$types = json_decode($items->name, true);
							?>
							<td>{{ $types['en']}}</td>
							<td><a href="/admin/experience/{{$items->id}}/edit?locale=en" class="btn btn-xs btn-primary">
									<i class="far fa-edit"></i> Edit
								</a>

								<a href="#" onclick="exprncHandleDelete({{$items->id}})" class="btn btn-xs btn-danger" data-button-type="delete">
