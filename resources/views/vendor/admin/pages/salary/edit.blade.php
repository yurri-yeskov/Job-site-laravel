        ...
        <form method="POST" action="{{ request()->fullUrl() }}">
            <div class="card border-top border-primary">
                ...
                <div class="card-header">
                    <h3 class="mb-0">Update salary</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="card mb-0">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>From</label>
                                <input type="text" name="from" value="{{$salary->min_name}}" placeholder="Min salary" class="form-control">
                            </div>
                            <div class="form-group col-md-6">
                                <label>To</label>
                                <input type="text" name="to" value="{{$salary->name}}" placeholder="Max salary" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
