	...
	<div class="col-12">
		...
		<div class="card rounded">
			...
			<div class="card-header with-border pt-5">
				<a href="/admin/salary/create" class="btn btn-primary shadow ladda-button" data-style="zoom-in">
					<span class="ladda-label">
						<i class="fas fa-plus"></i> Add salary option
					</span>
				</a>
				...
				<table id="crudTable" class="crudTable table table-bordered table-striped display dt-responsive nowrap" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $items->min_name}}</td>
							<td>{{ $items->name}}</td>
							<td><a href="/admin/salary/{{$items->id}}/edit?locale=en" class="btn btn-xs btn-primary">
									<i class="far fa-edit"></i> Edit
								</a>

								<a href="#"  onclick="salaryHandleDelete({{$items->id}})"  class="btn btn-xs btn-danger" data-button-type="delete">
