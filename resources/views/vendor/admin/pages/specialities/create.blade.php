...
<div class="row page-titles">
    ...
    <div class="col-md-6 col-12 align-self-center d-none d-md-block">
        <ol class="breadcrumb mb-0 p-0 bg-transparent float-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('employerSetting')}}" class="text-capitalize">{{ trans('Specialities') }}</a></li>
...
<div class="flex-row d-flex justify-content-center">
    ...
    <div class="col-sm-12{{ $colMd }}">
        ...
        <form method="POST" action="/admin/specialities">
            <div class="card border-top border-primary">

                <div class="card-header">
                    <h3 class="mb-0">Add a new speciality</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="card mb-0">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Name</label>
                                <input type="text" name="name" value="" placeholder="speciality" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
